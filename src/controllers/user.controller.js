...
class UserController {
    async register(req, res) {
        const { first_name, last_name, email, cart_id, age , password } = req.body; 
        try {
            const nuevoUsuario = await UserService.registerUser({ first_name, last_name, email, cart_id, age , password }); 
